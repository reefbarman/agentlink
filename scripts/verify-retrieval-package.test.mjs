...
test("rejects an inventory without the standalone CLI guide", () => {
  assert.throws(
    () =>
      verifyRetrievalPackageFiles(
        inventory(
    ...
    /missing required paths: resources\/builtin-skills\/documentation\/references\/standalone-cli\.md/u,
  );
});
