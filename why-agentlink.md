...
- **Compaction without amnesia.** Long sessions auto-condense with per-model thresholds, deterministically carry the structured TODO list and its completion states into resume context, tell the resumed agent to reconcile stale bookkeeping rather than repeat finished work, and expose transcript recall for re-reading retired history.
