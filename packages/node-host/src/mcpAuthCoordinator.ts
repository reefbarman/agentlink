...
/** The host owns sanitization and persistence of auth events. */
export type McpAuthEvent = {
  ...
  readonly tokenGenerationAfter?: number;
  readonly hasSavedTokens?: boolean;
  readonly hasRefreshToken?: boolean;
  readonly browserOpened?: boolean;
  readonly leaseOutcome?: "acquired" | "contended" | "error" | "skipped";
  ...
  | {
      readonly type: "connect_auth_failure";
      readonly errorKind: McpAuthErrorKind;
    }
  | {
      readonly type: "refresh_fallback" | "runtime_reconnect";
      readonly errorKind?: McpAuthErrorKind;
    }
  | { readonly type: "browser_open_result"; readonly browserOpened: boolean }
  | {
      readonly type: "browser_open_blocked";
      readonly decisionReason: Exclude<McpAuthDecisionReason, "allowed">;
    }
  | {
      readonly type: "oauth_callback";
      readonly callbackOutcome: "success" | "error" | "timeout" | "cancelled";
      readonly errorKind?: McpAuthErrorKind;
    }
);

type McpAuthDecisionReason =
  | "allowed"
  | "blocked_cooldown"
  | "blocked_lease"
  | "blocked_manual_reauth"
...
export interface McpAuthEventRecorder {
...
export class McpAuthCoordinator {
  ...
  private telemetry?: McpAuthEventRecorder;
  ...
  setTelemetry(telemetry: McpAuthEventRecorder | undefined): void {
