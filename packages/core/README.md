...
| `codex`                                                                                       | Codex model policy, request/response translation, normalized errors, and host-injected OpenAI client construction.   |
