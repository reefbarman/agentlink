      ...
      typecheck = typecheck
        .then(async () => {
          ...
          await Promise.all([
            ...
            copyFile(
              "dist/structuredQuestion.d.ts",
              "dist/cjs/structuredQuestion.d.cts",
            ),
            copyFile(
            ...
            copyFile(
              "dist/autonomousMemory.d.ts",
              "dist/cjs/autonomousMemory.d.cts",
            ),
            ...
            readFile(
              "dist/browserGatewayCoreOwnerRegistration.d.ts",
              "utf8",
            ).then((content) =>
              writeFile(
            ...
            readFile("dist/browserGatewayDataPlaneLimits.d.ts", "utf8").then(
              (content) =>
                writeFile(
            ...
            readFile("dist/browserGatewayInteractionState.d.ts", "utf8").then(
              (content) =>
                writeFile(
            ...
            readFile("dist/browserGatewayOperationState.d.ts", "utf8").then(
              (content) =>
                writeFile(
            ...
            readFile("dist/browserGatewayTranscriptBlock.d.ts", "utf8").then(
              (content) =>
                writeFile(
            ...
            readFile("dist/browserGatewayTranscriptText.d.ts", "utf8").then(
              (content) =>
                writeFile(
            ...
            readFile("dist/chatTranscript.d.ts", "utf8").then((content) =>
              writeFile(
                ...
                content
                  ...
                  .replaceAll(
                    '"./contextDiagnostics.js"',
                    '"./contextDiagnostics.cjs"',
                  )
            ...
            copyFile(
              "dist/agentPluginManager.d.ts",
              "dist/cjs/agentPluginManager.d.cts",
            ),
            copyFile("dist/diffSnapshot.d.ts", "dist/cjs/diffSnapshot.d.cts"),
            copyFile(
              "dist/embeddedAgentPresentation.d.ts",
              "dist/cjs/embeddedAgentPresentation.d.cts",
            ),
            readFile("dist/embeddedAgentTransport.d.ts", "utf8").then(
              (content) =>
                writeFile(
                  "dist/cjs/embeddedAgentTransport.d.cts",
                  content
                    .replaceAll(
                      '"./embeddedAgentPresentation.js"',
                      '"./embeddedAgentPresentation.cjs"',
                    )
                    .replaceAll('"./modelCatalog.js"', '"./modelCatalog.cjs"'),
                ),
            ),
            ...
            copyFile(
              "dist/mcpElicitation.d.ts",
              "dist/cjs/mcpElicitation.d.cts",
            ),
            copyFile("dist/mcpManager.d.ts", "dist/cjs/mcpManager.d.cts"),
            copyFile(
              "dist/mcpToolIdentity.d.ts",
              "dist/cjs/mcpToolIdentity.d.cts",
            ),
            copyFile(
              "dist/mcpUrlElicitation.d.ts",
              "dist/cjs/mcpUrlElicitation.d.cts",
            ),
            ...
            copyFile(
              "dist/providerReplay.d.ts",
              "dist/cjs/providerReplay.d.cts",
            ),
            copyFile(
            ...
            copyFile(
              "dist/questionDetection.d.ts",
              "dist/cjs/questionDetection.d.cts",
            ),
            ...
            readFile("dist/retrievalStructuralSnapshot.d.ts", "utf8").then(
              (content) =>
                writeFile(
            ...
            copyFile(
              "dist/semanticReadiness.d.ts",
              "dist/cjs/semanticReadiness.d.cts",
            ),
            ...
            copyFile(
              "dist/todoContinuation.d.ts",
              "dist/cjs/todoContinuation.d.cts",
            ),
            ...
            copyFile(
              "dist/workspaceProject.d.ts",
              "dist/cjs/workspaceProject.d.cts",
            ),
          ]);
        })
        .catch((error) => {
