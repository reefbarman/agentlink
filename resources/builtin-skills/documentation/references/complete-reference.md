...
`review` is a first-class mode across backend/UI/settings and is designed for structured technical review output. It includes terminal commands for tests, build/lint checks, Git inspection, and tools such as `gh`; commands use the normal approval and execution policy. Review mode does not include file-edit tools.
