  ...
  it("writes one enveloped JSONL line per event", async () => {
    ...
    telemetry.record({
      ...
      composeEfficiency: {
        ...
        advertisedRequestCount: 2,
        composeOpportunityTurns: 1,
        candidateFanoutTurns: 0,
        directComposableCalls: 1,
        composeCalls: 1,
        sameTurnRepairs: 1,
        directComposableHistoryTokens: 20,
        composeHistoryTokens: 30,
        foldedContextReadCount: 2,
        foldedContextTokens: 40,
        inlineDefinitionTokens: 50,
        providerAttempts: 2,
        inputTokens: 100,
