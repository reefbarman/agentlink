...
export function mapReasoningEfforts(
  ...
  const levels: CoreReasoningEffort[] = ["none"];
...
export class AnthropicModelCatalog {
  ...
  private inFlight: Promise<AnthropicModelInfo[]> | undefined;
   ...
   */
  async refresh(modelsApi: AnthropicModelsApi): Promise<AnthropicModelInfo[]> {
